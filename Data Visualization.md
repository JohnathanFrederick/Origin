As funções abaixo tem por finalidade a criação de gráficos em massa, com agrupamento de diversos dados por gráfico. O agrupamento do conjunto de dados é feito através do Short Name das WorksheetsPages (Workbooks) presente no arquivo Origin aberto.
